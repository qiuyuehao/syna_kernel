...
static signed char *g_td43xx_rt95_part_one = NULL;
static signed char *g_td43xx_rt95_part_two = NULL;
...
int synap_get_cap_data(struct ts_rawdata_info *info)
{
	...
	tx_delta_buf = (char*)info->tx_delta_buf;
	rx_delta_buf = (char*)info->rx_delta_buf;
	g_td43xx_rt95_part_one = (char*)info->td43xx_rt95_part_one;
	g_td43xx_rt95_part_two = (char*)info->td43xx_rt95_part_two;
